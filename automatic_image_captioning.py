# -*- coding: utf-8 -*-
"""Automatic_Image_Captioning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18EYxaqt5QHzCN3l_BDG9LiaDbYH_lY6L
"""
...
cp -r /content/drive/My\ Drive/Flickr8k_text /content

# Below path contains all the images

images = '/content/drive/My Drive/Flicker8k_Dataset/'
# Create a list of all image names in the directory
img = glob.glob(images + '*.jpg')
print(img)
#print(images)

!unzip('/content/drive/My Drive/FAQ.rar')
...
!wget "https://www.kaggle.com/incorpes/glove6b200d/downloads/glove6b200d.zip"

!cp /content/glove.6B.200d.txt /content/glove/
